from db.dbFunctions import ReadBooks, CreateBook, ReadUser, CreateUser, ReadPrestamos, CreatePrestamo
...
def main():
    while True:
        ...
        if opcion == "1":
            limpiar_consola()
            mostrar_libros()  # Mostrar la lista de libros
            ...
            mostrar_usuarios()  # Mostrar la lista de usuarios
            ...
            limpiar_consola()
            mostrar_prestamos()  # Mostrar la lista de préstamos
            input("\nPresione Enter para continuar...")
